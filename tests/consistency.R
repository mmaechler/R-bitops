...
aNA <- a; aNA[] <- NA ; stopifnot(is.na(aNA), is.numeric(aNA))
##
stopifnot(identical(bitAnd(a,a)[-b], aNA[-b]))
stopifnot(identical(bitAnd(a,a)[b], a[b]))
stopifnot(identical(bitOr(a,a)[-b], aNA[-b]))
stopifnot(identical(bitOr(a,a)[b], a[b]))
stopifnot(identical(bitXor(a,0)[-b], aNA[-b]))
stopifnot(identical(bitXor(a,0)[b], a[b]))
stopifnot(identical(bitXor(0,a)[-b], aNA[-b]))
stopifnot(identical(bitXor(0,a)[b], a[b]))
stopifnot(identical(bitFlip(bitFlip(a))[-b], aNA[-b]))
stopifnot(identical(bitFlip(bitFlip(a))[b], bitAnd(a,2^32-1)[b]))
stopifnot(identical(bitShiftR(a,runif(10)*32)[-b], aNA[-b]))
stopifnot(identical(bitShiftL(a,runif(10)*32)[-b], aNA[-b]))
